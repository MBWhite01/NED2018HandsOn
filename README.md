...
6. Add the 'Demo Request' quick action to the Opportunity Page Layout.
  ...
  Select the **'Mobile & Lightning Actions'** section from the layout toolbar and drag the **'Demo Request'** action inot the **Salesforce Mobile and Lightning Experience Actions'** section of the layout.
